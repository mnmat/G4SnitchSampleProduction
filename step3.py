...
fname = outfile_.replace("step3_","dumper_")
...
histFile_  = "file:{}/dumper_{}_e{}GeV_eta{}_z{}_events{}_nopu_{}.root".format(outfolder, nameprefix, en_str, eta_str,caps,nevents,idx)
process.TFileService = cms.Service("TFileService",
    fileName = cms.string(histFile_),
