...
parser.add_argument('--sample', help="Data sample", choices=['singlepi', 'singlephoton', 'singleel', 'singlekaon', 'singlemuon', 'all'], type=str, nargs='+')
parser.add_argument('--energies', help="Energies for each sample", choices=['10', '20', '50', '100','300','600','all'], type=str, nargs='+')
parser.add_argument('--etas', help = "Eta for each sample", choices = ['1.6', '1.7','1.9','2.1','2.3','2.5','2.7', '2.9', '1.7_2.7', 'all'], type=str, nargs='+')
parser.add_argument('--nevents', help = "Number of events", choices = ['1', '10', '100','500', '1000', '10000', 'all'], type=str, nargs='+')
...
samples = args.sample
if args.sample == ['all']:
  samples = ['singlepi', 'singlephoton', 'singleel', 'singlekaon', 'singlemuon']
      ...
      for nevent in nevents:
        for cap in caps:
          ...
          for en in energies:
            ...
            command = "cmsRun step1_%s.py %s %s %s %s %s %s %i %s %i"%(genProducer[sample], en, eta, sample, nevent, cap, outFolder, nthreads,idx,initialSeed)
